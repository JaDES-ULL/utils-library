...
public class OntologyTest {
    ...
    public OWLOntologyWrapper createDefaultOwlOntologyWrapper() throws OWLOntologyCreationException {
        try {
            ...
            tmp.deleteOnExit();
            Files.copy(Objects.requireNonNull(getClass().getResourceAsStream(OntologyTestResources.SCHEMA_FILE)), tmp.toPath(), StandardCopyOption.REPLACE_EXISTING);
            final OntologyLoadOptions options = new OntologyLoadOptions.Builder()
                    ...
                    .build();
            final LoadedOntology loaded = loader.load(new StreamDocumentSource(Objects.requireNonNull(getClass().getResourceAsStream(OntologyTestResources.DATA_FILE))), options); 
    ...
    public void testOntologyLoading() throws OWLOntologyCreationException {
        final InputStream schemaStream = Objects.requireNonNull(getClass().getResourceAsStream(OntologyTestResources.SCHEMA_FILE));
        final LoadedOntology loaded = loader.load(new StreamDocumentSource(schemaStream));
        final OWLOntologyWrapper ontologyWrapper = new OWLOntologyWrapper(loaded);
        assertEquals(OntologyTestResources.SCHEMA_IRI, ontologyWrapper.getOntology().getOntologyID().getOntologyIRI().get().toString());
        log.debug("Ontology loaded: " + ontologyWrapper.getOntology().getOntologyID());
    }

    @Test
    public void testRemoteOntologyLoading() throws OWLOntologyCreationException {
        final LoadedOntology loaded = loader.load(new IRIDocumentSource(Objects.requireNonNull(IRI.create(REMOTE_ONTOLOGY_VERSIONED_IRI))));
        final OWLOntologyWrapper ontologyWrapper = new OWLOntologyWrapper(loaded);
    ...
    public void testRemoteIndividualsLoading() throws OWLOntologyCreationException {
        final LoadedOntology loaded = loader.load(new IRIDocumentSource(Objects.requireNonNull(IRI.create(REMOTE_INDIVIDUALS_VERSIONED_IRI))));
        final OWLOntologyWrapper ontologyWrapper = new OWLOntologyWrapper(loaded);
        final IRI classDiseaseIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_CLASS);
        final IRI individualDiseaseIRI = ontologyWrapper.toIRI(REMOTE_TEST_DISEASE_INDIVIDUAL);
        final IRI wrongIndividualDiseaseIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_INDIVIDUAL);
        ...
        assertTrue(!diseaseIRIs.contains(wrongIndividualDiseaseIRI), "The disease individual " + OntologyTestResources.TEST_DISEASE_INDIVIDUAL + " should not be present");
    ...
    public void testOntologyIndividuals() throws OWLOntologyCreationException {
        ...
        final IRI classDiseaseIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_CLASS);
        final IRI individualDiseaseIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_INDIVIDUAL);
        final IRI preloadedIndividualDiseaseIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL);
    ...
    public void testAddObjectPropertyValue() throws OWLOntologyCreationException {
        final OWLOntologyWrapper ontologyWrapper = createDefaultOwlOntologyWrapper();
        final IRI diseaseClassIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_CLASS);
        final IRI modelClassIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_MODEL_CLASS);
        final IRI diseaseIndividualIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_INDIVIDUAL);
        final IRI modelIndividualIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_MODEL_INDIVIDUAL);
        ...
        final IRI includedByModelPropertyIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_OBJ_PROPERTY);
        ...
        log.debug("Property values for '" + OntologyTestResources.TEST_DISEASE_OBJ_PROPERTY + "' of " + OntologyTestResources.TEST_DISEASE_INDIVIDUAL + ":");
        includedByModelIris.forEach(ind -> log.debug(" - " + ind));
        assertTrue(includedByModelIris.contains(modelIndividualIRI), "The includedByModel property should contain " + OntologyTestResources.TEST_MODEL_INDIVIDUAL);
    ...
    public void testAddDataPropertyValue() throws OWLOntologyCreationException {
        ...
        final IRI invalidDiseaseIndividualIRI = ontologyWrapper.toIRI(TEST_INVALID_DISEASE_INDIVIDUAL);
        final IRI invalidModelIndividualIRI = ontologyWrapper.toIRI(TEST_INVALID_MODEL_INDIVIDUAL);
        final IRI diseaseDataPropertyIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_DATA_PROPERTY);
        final IRI invalidDiseaseDataPropertyIRI = ontologyWrapper.toIRI(TEST_INVALID_DISEASE_DATA_PROPERTY);
        final IRI modelDataPropertyIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_MODEL_DATA_PROPERTY);
        ...
        boolean added = ontologyWrapper.assertDataProperty(diseaseIndividualIRI, diseaseDataPropertyIRI, OntologyTestResources.TEST_DISEASE_DESCRIPTION);
        assertTrue(added, "The data property value should be added");
        // Invalid case: "T2DM" does not exist
        assertThrows(IllegalArgumentException.class, () -> {
            ontologyWrapper.assertDataProperty(invalidDiseaseIndividualIRI, diseaseDataPropertyIRI, OntologyTestResources.TEST_DISEASE_DESCRIPTION);
        }, "Asserting a data property for a non-existing individual should throw exception");
        added = ontologyWrapper.assertDataProperty(diseaseIndividualIRI, diseaseDataPropertyIRI, OntologyTestResources.TEST_DISEASE_DESCRIPTION);
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            ontologyWrapper.assertDataProperty(diseaseIndividualIRI, invalidDiseaseDataPropertyIRI, OntologyTestResources.TEST_DISEASE_DESCRIPTION);
        }, "Asserting a data property for a non-existing property should throw exception");

        // Valid case: T1DM_Model has a year
        added = ontologyWrapper.assertDataProperty(modelIndividualIRI, modelDataPropertyIRI, OntologyTestResources.TEST_MODEL_STUDY_YEAR, OWL2Datatype.XSD_INTEGER);
        assertTrue(added, "The data property value should be added");
        // Invalid case: "T2DM_Model" does not exist
        assertThrows(IllegalArgumentException.class, () -> {
        ...
        log.debug("Property values for '" + OntologyTestResources.TEST_DISEASE_DATA_PROPERTY + "' of " + OntologyTestResources.TEST_DISEASE_INDIVIDUAL + ":");
        dataPropertyValues.forEach(ind -> log.debug(" - " + ind));
        assertTrue(dataPropertyValues.size() == 1, "The " + OntologyTestResources.TEST_DISEASE_DATA_PROPERTY + " property should have exactly one value");
        OWLLiteral descLiteral = ontologyWrapper.getDataFactory().getOWLLiteral(OntologyTestResources.TEST_DISEASE_DESCRIPTION);
        assertTrue(dataPropertyValues.contains(descLiteral), "The " + OntologyTestResources.TEST_DISEASE_DATA_PROPERTY + " property should contain '" + OntologyTestResources.TEST_DISEASE_DESCRIPTION + "'");
        dataPropertyValues = ontologyWrapper.getDataPropertyValues(modelIndividualIRI, modelDataPropertyIRI, Imports.INCLUDED);
        log.debug("Property values for '" + OntologyTestResources.TEST_MODEL_DATA_PROPERTY + "' of " + OntologyTestResources.TEST_MODEL_INDIVIDUAL + ":");
        dataPropertyValues.forEach(ind -> log.debug(" - " + ind));
        assertTrue(dataPropertyValues.size() == 1, "The " + OntologyTestResources.TEST_MODEL_DATA_PROPERTY + " property should have exactly one value");
        assertTrue(dataPropertyValues.contains(ontologyWrapper.getDataFactory().getOWLLiteral(OntologyTestResources.TEST_MODEL_STUDY_YEAR, OWL2Datatype.XSD_INTEGER)), "The " + OntologyTestResources.TEST_MODEL_DATA_PROPERTY + " property should contain '" + OntologyTestResources.TEST_MODEL_STUDY_YEAR + "'");
    }
    ...
    public void testOntologyRetrieval() throws OWLOntologyCreationException {
        ...
        // These should be ok...
        final IRI testPreloadedDiseaseIndividualIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL);
        final IRI testDiseaseIndividualIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_INDIVIDUAL);
        assertNotNull(ontologyWrapper.asOWLIndividual(testPreloadedDiseaseIndividualIRI), "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should exist");
        assertTrue(ontologyWrapper.findOWLIndividual(testPreloadedDiseaseIndividualIRI).isPresent(), "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should exist");
        // This should be ok...
        assertTrue(ontologyWrapper.findOWLIndividual(testDiseaseIndividualIRI).isEmpty(), "The individual " + OntologyTestResources.TEST_DISEASE_INDIVIDUAL + " should not exist");
        // ... but this too
        assertNotNull(ontologyWrapper.asOWLIndividual(testDiseaseIndividualIRI), "The individual " + OntologyTestResources.TEST_DISEASE_INDIVIDUAL + " should not exist but this method should work anyway");
        ...
        // Checking classes
        // These should be ok...
        final IRI testDiseaseClassIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_CLASS);
        final IRI testModelClassIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_MODEL_CLASS);
        final IRI testInvalidClassIRI = ontologyWrapper.toIRI(TEST_INVALID_CLASS);
        assertNotNull(ontologyWrapper.asOWLClass(testDiseaseClassIRI), "The class " + OntologyTestResources.TEST_DISEASE_CLASS + " should exist");
        assertTrue(ontologyWrapper.findOWLClass(testModelClassIRI).isPresent(), "The class " + OntologyTestResources.TEST_MODEL_CLASS + " should exist");
        // This should be ok...
        ...
        // These should be ok...
        final IRI testDiseaseDataPropertyIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_DATA_PROPERTY);
        final IRI testInvalidDiseaseDataPropertyIRI = ontologyWrapper.toIRI(TEST_INVALID_DISEASE_DATA_PROPERTY);
        assertNotNull(ontologyWrapper.asOWLDataProperty(testDiseaseDataPropertyIRI), "The data property " + OntologyTestResources.TEST_DISEASE_DATA_PROPERTY + " should exist");
        assertTrue(ontologyWrapper.findOWLDataProperty(testDiseaseDataPropertyIRI).isPresent(), "The data property " + OntologyTestResources.TEST_DISEASE_DATA_PROPERTY + " should exist");
        // This should be ok...
        ...
        // These should be ok...
        final IRI testDiseaseObjectPropertyIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_DISEASE_OBJ_PROPERTY);
        final IRI testInvalidDiseaseObjectPropertyIRI = ontologyWrapper.toIRI(TEST_INVALID_DISEASE_OBJ_PROPERTY);
        assertNotNull(ontologyWrapper.asOWLObjectProperty(testDiseaseObjectPropertyIRI), "The object property " + OntologyTestResources.TEST_DISEASE_OBJ_PROPERTY + " should exist");
        assertTrue(ontologyWrapper.findOWLObjectProperty(testDiseaseObjectPropertyIRI).isPresent(), "The object property " + OntologyTestResources.TEST_DISEASE_OBJ_PROPERTY + " should exist");
        // This should be ok...
    ...
    public void testOntologyStructure() throws OWLOntologyCreationException {
        final OWLOntologyWrapper ontologyWrapper = createDefaultOwlOntologyWrapper();
        final IRI testPreloadedDiseaseIndividualIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL);
        final IRI testDiseaseClassIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_RARE_DISEASE_CLASS);
        final IRI testSuperClassIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_SUPER_CLASS);
        final IRI testModelClassIRI = ontologyWrapper.toIRI(OntologyTestResources.TEST_MODEL_CLASS);
        assertTrue(ontologyWrapper.isInstanceOf(testPreloadedDiseaseIndividualIRI, testDiseaseClassIRI, Imports.INCLUDED, InstanceCheckMode.ASSERTED_DIRECT),
            "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should be a subclass of " + OntologyTestResources.TEST_RARE_DISEASE_CLASS); 
        assertTrue(!ontologyWrapper.isInstanceOf(testPreloadedDiseaseIndividualIRI, testSuperClassIRI, Imports.INCLUDED, InstanceCheckMode.ASSERTED_DIRECT),
            "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should not be determined to be a subclass of " + OntologyTestResources.TEST_SUPER_CLASS + " without inference");
        assertTrue(ontologyWrapper.isInstanceOf(testPreloadedDiseaseIndividualIRI, testSuperClassIRI, Imports.INCLUDED, InstanceCheckMode.INFERRED_ALL),
            "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should be a subclass of " + OntologyTestResources.TEST_SUPER_CLASS + " with inference");
        assertTrue(!ontologyWrapper.isInstanceOf(testPreloadedDiseaseIndividualIRI, testModelClassIRI, Imports.INCLUDED, InstanceCheckMode.ASSERTED_DIRECT),
            "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should not be a subclass of " + OntologyTestResources.TEST_MODEL_CLASS);
        ...
        log.debug("Classes for individual '" + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + "':");
        classIRIs.forEach(c -> log.debug(" - " + c));
        assertTrue(classIRIs.size() == 3, OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should belong to 3 classes");
        assertTrue(classIRIs.contains(testDiseaseClassIRI), "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should belong to class " + OntologyTestResources.TEST_DISEASE_CLASS);
        assertTrue(classIRIs.contains(testSuperClassIRI), "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should belong to class " + OntologyTestResources.TEST_SUPER_CLASS);
        classIRIs = ontologyWrapper.getTypes(testPreloadedDiseaseIndividualIRI, Imports.INCLUDED, InstanceCheckMode.ASSERTED_DIRECT);
        log.debug("DIRECT Classes for individual '" + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + "':");
        classIRIs.forEach(c -> log.debug(" - " + c));
        assertTrue(classIRIs.size() == 1, OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should belong to 1 class");
        assertTrue(classIRIs.contains(testDiseaseClassIRI), "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should belong to class " + OntologyTestResources.TEST_DISEASE_CLASS);
        assertTrue(!classIRIs.contains(testSuperClassIRI), "The individual " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " should not (directly) belong to class " + OntologyTestResources.TEST_SUPER_CLASS);
    }
    ...
    public void testLabelRetrieval() throws OWLOntologyCreationException {
        ...
        assertTrue(label.isPresent(), "Label for " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " in English should be present");
        log.debug("Label for " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " in English: " + label.get());
        ...
        assertTrue(label.isPresent(), "Label for " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " in Spanish should be present");
        log.debug("Label for " + OntologyTestResources.TEST_PRELOADED_DISEASE_INDIVIDUAL + " in Spanish: " + label.get());
    ...
    public void testOntologyDoubleLoading() throws OWLOntologyCreationException {
        final LoadedOntology loaded = loader.load(new StreamDocumentSource(Objects.requireNonNull(getClass().getResourceAsStream(OntologyTestResources.SCHEMA_FILE))));
        final URL url = Objects.requireNonNull(getClass().getResource(OntologyTestResources.SCHEMA_FILE));
        ...
        final LoadedOntology loadedWithMapping = loader.load(new StreamDocumentSource(Objects.requireNonNull(getClass().getResourceAsStream(OntologyTestResources.DATA_FILE))), loaded.manager());
        final OWLOntologyWrapper ontologyWrapper = new OWLOntologyWrapper(loadedWithMapping);
        log.debug("Ontology loaded: " + ontologyWrapper.getOntology().getOntologyID());
        
        final OWLOntology mergedOntology = ontologyWrapper.loadOntology(new StreamDocumentSource(Objects.requireNonNull(getClass().getResourceAsStream(OntologyTestResources.DATA_FILE))));
    ...
    public void testNonCompliantOntology() throws OWLOntologyCreationException {
        assertThrows(OWLOntologyCreationException.class, () -> {
            final LoadedOntology loaded = loader.load(new StreamDocumentSource(Objects.requireNonNull(getClass().getResourceAsStream(WRONG_DATA_FILE))));
            new OWLOntologyWrapper(loaded, new OWL2DLProfile());
